diff --git a//dev/null b/scripts/print_auth_link.py
index 0000000000000000000000000000000000000000..384ef946f4cbc19430bf1390121a8ac360e4dc3f 100644
--- a//dev/null
+++ b/scripts/print_auth_link.py
@@ -0,0 +1,112 @@
